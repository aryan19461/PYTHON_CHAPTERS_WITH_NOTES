...
class Bill_App:
    ...
    # ===========ColdDrinks================================
        ...
        FreshLime_lbl = Label(F4, text="FreshLime", font=('times new roman', 16, 'bold'), bg="#badc57", fg="black")
        FreshLime_lbl.grid(row=1, column=0, padx=10, pady=10, sticky='W')
        FreshLime_txt = Entry(F4, width=10, textvariable=self.FreshLime, font=('times new roman', 16, 'bold'), bd=5, relief=GROOVE)
        FreshLime_txt.grid(row=1, column=1, padx=10, pady=10)
...
#================totalBill==========================
    def total(self):
        ...
        self.c_d_l_p = self.FreshLime.get()*10
...
#=========billArea=================================================
    ...
    # ==============Grocery============================
        ...
        if self.FreshLime.get() != 0:
            self.txtarea.insert(END, f"\n Sanitizer\t\t{self.FreshLime.get()}\t\t{self.c_d_l_p}")
        if self.mazza.get() != 0:
